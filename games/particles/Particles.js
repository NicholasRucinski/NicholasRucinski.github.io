...
var ASM_CONSTS = {
  108320: () => { if (document.fullscreenElement) return 1; },  
 108366: () => { return Module.canvas.width; },  
 108398: () => { return parseInt(Module.canvas.style.width); },  
 108446: () => { document.exitFullscreen(); },  
 108473: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 108546: () => { if (document.fullscreenElement) return 1; },  
 108592: () => { return Module.canvas.width; },  
 108624: () => { return screen.width; },  
 108649: () => { document.exitFullscreen(); },  
 108676: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 108809: () => { return window.innerWidth; },  
 108835: () => { return window.innerHeight; },  
 108862: () => { if (document.fullscreenElement) return 1; },  
 108908: () => { return Module.canvas.width; },  
 108940: () => { return parseInt(Module.canvas.style.width); },  
 108988: () => { if (document.fullscreenElement) return 1; },  
 109034: () => { return Module.canvas.width; },  
 109066: () => { return screen.width; },  
 109091: () => { return window.innerWidth; },  
 109117: () => { return window.innerHeight; },  
 109144: () => { if (document.fullscreenElement) return 1; },  
 109190: () => { return Module.canvas.width; },  
 109222: () => { return screen.width; },  
 109247: () => { document.exitFullscreen(); },  
 109274: () => { if (document.fullscreenElement) return 1; },  
 109320: () => { return Module.canvas.width; },  
 109352: () => { return parseInt(Module.canvas.style.width); },  
 109400: () => { document.exitFullscreen(); },  
 109427: ($0) => { Module.canvas.style.opacity = $0; },  
 109465: () => { return screen.width; },  
 109490: () => { return screen.height; },  
 109516: () => { return window.screenX; },  
 109543: () => { return window.screenY; },  
 109570: () => { return window.devicePixelRatio; },  
 109606: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 109659: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 109710: () => { Module.canvas.style.cursor = 'none'; },  
 109747: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 110003: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 110054: () => { if (document.pointerLockElement) return 1; },  
 110101: () => { if (document.fullscreenElement) return 1; },  
 110147: () => { return window.innerWidth; },  
 110173: () => { return window.innerHeight; }
};
